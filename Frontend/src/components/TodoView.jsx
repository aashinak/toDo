    ...
    <div className="w-full text-white">
      <div className="w-full p-8 rounded-lg border border-[rgba(255,255,255,0.10)] flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          {active === "Pending" ? (
            <p onClick={handleUpdateTodo} className="p-1 cursor-pointer  hover:bg-[#212121]  rounded-lg border border-[rgba(255,255,255,0.10)] font-light text-gray-400 text-sm">
              mark as completed
            </p>
          ) : (
            <p onClick={handleUpdateTodo} className="p-1 cursor-pointer hover:bg-[#212121]  rounded-lg border border-[rgba(255,255,255,0.10)] font-light text-gray-400 text-sm">mark as incomplete</p>
          )}
